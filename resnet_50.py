...
from utils import get_json, get_random_data, data_generator_wrapper, unzip
...
if __name__ == '__main__':
    ...
    train_image_dir = '/Users/xiang/Downloads/dataset/AIC_disease/ai_challenger_pdr2018_trainingset_20180905/AgriculturalDisease_trainingset/images/'
    val_image_dir = '/Users/xiang/Downloads/dataset/AIC_disease/ai_challenger_pdr2018_validationset_20180905/AgriculturalDisease_validationset/images/'
    ...
    # Start Fine-tuning
    model.fit_generator(data_generator_wrapper(train_anno_list, batch_size, input_shape, train_image_dir, is_dark=False),
                steps_per_epoch=max(1, num_train//batch_size),
                validation_data=data_generator_wrapper(val_anno_list, batch_size, input_shape, val_image_dir, is_dark=False),
                validation_steps=max(1, num_val//batch_size),
                epochs=50,
                initial_epoch=0,
                callbacks=[logging, checkpoint])
    model.save_weights(log_dir + 'trained_weights_stage_1_resnet.h5')
